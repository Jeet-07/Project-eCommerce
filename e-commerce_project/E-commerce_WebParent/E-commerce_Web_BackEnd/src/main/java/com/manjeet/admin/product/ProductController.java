...
import com.manjeet.admin.brand.BrandService;
...
public class ProductController {
    ...
    public String deleteProduct(@PathVariable(name = "id") Integer id,
        ...
        try {
            ...
            FileUploadUtil.clean(productImagesDir);
    ...
    public String editProduct(@PathVariable("id") Integer id, Model model,
                              RedirectAttributes ra, @AuthenticationPrincipal CustomUserDetails loggedUser) {
        try {
