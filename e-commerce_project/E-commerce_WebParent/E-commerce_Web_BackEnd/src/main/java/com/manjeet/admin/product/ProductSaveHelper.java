...
import com.manjeet.common.entity.product.ProductImage;
...
public class ProductSaveHelper {
	...
	static void deleteExtraImagesRemovedOnForm(Product product) {
		...
		FileUploadUtil.cleanProductExtras(extraImageDir,product);
	}
	...
	static void saveUploadedImages(MultipartFile mainImageMultipart,
		...
		if (!mainImageMultipart.isEmpty()) {
			...
			String deleteFileName = savedProduct.getMainImagePath();

			FileUploadUtil.deleteFile(uploadDir,deleteFileName);
